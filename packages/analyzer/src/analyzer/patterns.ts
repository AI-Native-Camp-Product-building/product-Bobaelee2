 ...
 * C(핵심): 명령/지시/핵심만 전달 → b
 */
export function judgeVerboseAxis(stats: import('../types.js').MdStats, text?: string): { a: number; b: number } {
  let a = 0;
  let b = 0;
 ...
 */
export function judgeControlFromSettings(text: string, stats?: import('../types.js').MdStats): { a: number; b: number } {
  let a = 0;
  let b = 0;
