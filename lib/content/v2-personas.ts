...
export const V2_PERSONAS: Record<string, V2PersonaDefinition> = {
  ...
  'GRVXS': { typeCode: 'GRVXS', name: '체계적 실험가', tagline: '해보면서 정리하는 사람', narrative: '이것저것 시도하면서도 기록은 체계적이다. 실험은 넓게, 정리는 깔끔하게. 당신의 설정 문서는 실험 노트처럼 깔끔하게 쌓여간다.', emoji: '🧪' },
  ...
  'GDVPS': { typeCode: 'GDVPS', name: '위임형 큐레이터', tagline: 'AI를 믿고, 좋은 것만 골라놓은 사람', narrative: '좋은 도구를 찾아서 세팅하되, AI에게는 자유를 준다. 맥락은 충분히 주지만 통제는 최소한. 당신의 문서는 가이드북이지 규칙집이 아니다.', emoji: '🎯' },
  ...
  // === 하네스(H) 계열 — 16개 ===
  'HRVPS': { typeCode: 'HRVPS', name: '결계 아키텍트', tagline: '빈틈없는 시스템의 설계자', narrative: '모든 규칙을 직접 설계하고, 모든 예외를 문서화하고, AI가 넘지 못할 선을 정확히 긋는다. 당신의 설정 문서를 보면 하나의 완성된 운영 매뉴얼이다. 빡빡하지만 — 그래서 신뢰할 수 있다.', emoji: '🏰' },
  ...
  'HDVPS': { typeCode: 'HDVPS', name: '시스템 철학자', tagline: '구조도 맥락도 풍부한, AI와의 대화를 설계하는 사람', narrative: '직접 만든 시스템 위에 풍부한 맥락을 올리고, AI에게는 자유를 준다. 통제보다 신뢰, 규칙보다 이해. 당신의 설정 문서는 철학서에 가깝다.', emoji: '📖' },
  ...
  'HRCPS': { typeCode: 'HRCPS', name: '정밀 기계', tagline: '짧고, 정확하고, 빈틈없는 시스템', narrative: '직접 만든 시스템, 짧지만 촘촘한 규칙, 깔끔한 구조. 한 줄도 낭비 없이 필요한 것만 담았다. 당신의 설정 문서는 정밀 기계의 도면이다.', emoji: '⚙️' },
