...
export const PERSONAS: Record<PersonaKey, PersonaDefinition> = {
  "puppet-master": {
    ...
    description:
      "hook, bot, pipeline, 자동화 스크립트로 가득 찬 설정 문서를 가진 당신. " +
      "AI에게 모든 걸 맡겨두고 퇴근한 척하지만, 사실 Slack 알림이 울릴 때마다 " +
  ...
  fortress: {
    ...
    description:
      ...
      "보안 규칙이 기능 코드보다 많은 설정 문서를 자랑스럽게 여기며, " +
  ...
  minimalist: {
    ...
    tagline: "AI야 알아서 해",
    description:
      "설정 문서에 '한국어로 답해줘' 딱 한 줄만 있는 당신. " +
      "간결함의 미학인지, 귀찮음의 승리인지는 본인만 알고 있음. " +
      "하지만 AI가 엉뚱한 답변을 할 때마다 '내가 더 적어놨어야 했나' 생각하지 않나요?",
  },
  collector: {
    key: "collector",
    nameKo: "플러그인 수집가",
  ...
  legislator: {
    ...
    emoji: "⚖️",
    tagline: "AI에게도 헌법이 필요하다",
    description:
      "MUST, NEVER, ALWAYS, CRITICAL, IMPORTANT가 설정 문서 전체를 뒤덮은 당신. " +
      "AI에게 규칙을 부여하는 게 취미이며, 혹시 AI가 규칙을 어기면 " +
  ...
  "deep-diver": {
    ...
    description:
      "설정 문서에 특정 주제 하나만 엄청나게 깊게 파고든 당신. " +
  ...
  evangelist: {
    ...
    description:
      "PR 규칙, 코드 리뷰, 팀 컨벤션, 브랜치 전략까지 설정 문서에 빼곡히 적은 당신. " +
      "AI를 개인 비서가 아니라 팀원 교육 도구로 쓰고 있음. " +
